...
// this api is needed to simplify
// high level programming and testing 
// of quadrotor that using ardupilot 
...
ros::Publisher global_local_lla_pos_pub;
ros::Publisher global_lla_pos_pub_raw;
ros::Subscriber currentPos;
ros::Subscriber currentPosGlobal;
...
// void pose_cb_global(const sensor_msg::NavSatFix::ConstPtr& msg)
// {
//   // to do
// }
...
{
	// this function subscribes to all necessary topics
	...
	global_local_lla_pos_pub = controlnode.advertise<geographic_msgs::GeoPoseStamped>(("/mavros/setpoint_position/global_to_local"), 10);
	...
	// currentPosGlobal = controlnode.subscribe<sensor_msgs::NavSatFix>(("/mavros/global_position/global"), 10, pose_cb_global);
